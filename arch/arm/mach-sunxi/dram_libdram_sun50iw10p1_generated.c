...
static unsigned int libdram_auto_cal_timing(int a1, int a2)
{
    unsigned int v2;     // r4
    unsigned int v3;     // r1
...
static void libdram_mctl_com_set_channel_timing(struct dram_para *result)
{
    int v1;               // r7
    ...
    LABEL_8:
        ...
        {
        case 3u:
            v58 = (unsigned __int8)libdram_auto_cal_timing(50, v9);
            v10 = (unsigned __int8)libdram_auto_cal_timing(10, v9);
            if ((unsigned __int8)v10 < 2u)
                v10 = 2;
            v38 = v10;
            v47 = (unsigned __int8)libdram_auto_cal_timing(15, v9);
            v57 = (unsigned __int8)libdram_auto_cal_timing(53, v9);
            v3 = (unsigned __int8)libdram_auto_cal_timing(8, v9);
            if (v3 < 2)
                v3 = 2;
            v59 = (unsigned __int8)libdram_auto_cal_timing(38, v9);
            LOBYTE(v4) = v3;
            v53 = (unsigned __int16)(libdram_auto_cal_timing(7800, v9) >> 5);
            v60 = (unsigned __int16)libdram_auto_cal_timing(350, v9);
            v5 = v47;
            v68 = (unsigned __int8)(libdram_auto_cal_timing(360, v9) >> 5);
            v48 = v3;
            goto LABEL_14;
        case 4u:
            v58 = (unsigned __int8)libdram_auto_cal_timing(35, v9);
            v13 = (unsigned __int8)libdram_auto_cal_timing(8, v9);
            if ((unsigned __int8)v13 < 2u)
                v13 = 2;
            v38 = v13;
            v14 = (unsigned __int8)libdram_auto_cal_timing(6, v9);
            if ((unsigned __int8)v14 < 2u)
                v14 = 2;
            v48 = v14;
            v15 = (unsigned __int8)libdram_auto_cal_timing(10, v9);
            if ((unsigned __int8)v15 < 8u)
                v15 = 8;
            v66 = v15;
            v47 = (unsigned __int8)libdram_auto_cal_timing(15, v9);
            v57 = (unsigned __int8)libdram_auto_cal_timing(49, v9);
            v16 = (unsigned __int8)libdram_auto_cal_timing(3, v9);
            if (!v16)
                LOBYTE(v16) = 1;
            v50 = v16;
            v59 = (unsigned __int8)libdram_auto_cal_timing(34, v9);
            v53 = (unsigned __int16)(libdram_auto_cal_timing(7800, v9) >> 5);
            v60 = (unsigned __int16)libdram_auto_cal_timing(350, v9);
            LOBYTE(v4) = v38;
            v68 = (unsigned __int8)(libdram_auto_cal_timing(360, v9) >> 5);
            ...
            goto LABEL_34;
        case 7u:
            v17 = (unsigned __int8)libdram_auto_cal_timing(50, v9);
            if ((unsigned __int8)v17 < 4u)
                v17 = 4;
            v58 = v17;
            v18 = (unsigned __int8)libdram_auto_cal_timing(10, v9);
            if (!v18)
                v18 = 1;
            v38 = v18;
            v19 = (unsigned __int8)libdram_auto_cal_timing(24, v9);
            if ((unsigned __int8)v19 < 2u)
                v19 = 2;
            v47 = v19;
            v57 = (unsigned __int8)libdram_auto_cal_timing(70, v9);
            v3 = (unsigned __int8)libdram_auto_cal_timing(8, v9);
            if (v3 < 2)
                v3 = 2;
            v5 = (unsigned __int8)libdram_auto_cal_timing(27, v9);
            v59 = (unsigned __int8)libdram_auto_cal_timing(42, v9);
            LOBYTE(v4) = v3;
            v53 = (unsigned __int16)(libdram_auto_cal_timing(3900, v9) >> 5);
            v60 = (unsigned __int16)libdram_auto_cal_timing(210, v9);
            v48 = v3;
            v67 = (unsigned __int8)libdram_auto_cal_timing(220, v9);
        LABEL_14:
            v11 = 2;
        LABEL_34:
            v56 = v11;
            break;
        case 8u:
            v58 = (unsigned __int8)libdram_auto_cal_timing(40, v9);
            v4 = (unsigned __int8)libdram_auto_cal_timing(10, v9);
            v20 = v4;
            if (v4 < 2)
                v20 = 2;
            v38 = v20;
            v21 = (unsigned __int8)libdram_auto_cal_timing(18, v9);
            if ((unsigned __int8)v21 < 2u)
                v21 = 2;
            v47 = v21;
            v57 = (unsigned __int8)libdram_auto_cal_timing(65, v9);
            v3 = (unsigned __int8)libdram_auto_cal_timing(8, v9);
            v22 = v3;
            if (v3 < 2)
                v22 = 2;
            ...
            if ((tpr13 & 0x10000000) != 0)
                v4 = (unsigned __int8)libdram_auto_cal_timing(12, v9);
            if (v4 < 4)
                LOBYTE(v4) = 4;
            if (v3 < 4)
                v3 = 4;
            v5 = (unsigned __int8)libdram_auto_cal_timing(21, v9);
            v59 = (unsigned __int8)libdram_auto_cal_timing(42, v9);
            v53 = (unsigned __int16)(libdram_auto_cal_timing(3904, v9) >> 5);
            v60 = (unsigned __int16)libdram_auto_cal_timing(280, v9);
            v67 = (unsigned __int8)libdram_auto_cal_timing(290, v9);
            v11 = 4;
            goto LABEL_34;
        }
        switch (type)
        {
        case 3u:
            LOBYTE(v6) = libdram_auto_cal_timing(8, v9);
            v41 = (unsigned __int8)libdram_auto_cal_timing(10, v9);
            if (v41 <= 2)
            {
                v6 = 6;
            }
            ...
            goto LABEL_72;
        case 4u:
            v23 = (unsigned __int8)libdram_auto_cal_timing(15, v9);
            if ((unsigned __int8)v23 < 0xCu)
                v23 = 12;
            v46 = v23;
            v6 = (unsigned __int8)libdram_auto_cal_timing(5, v9);
            if (v6 < 2)
                v6 = 2;
            v24 = (unsigned __int8)libdram_auto_cal_timing(10, v9);
            if ((unsigned __int8)v24 < 3u)
                v24 = 3;
            v55 = (unsigned __int8)(v6 + 1);
            v41 = v24;
            v42 = (unsigned __int8)(libdram_auto_cal_timing(170, v9) >> 5);
            v61 = (unsigned __int8)(libdram_auto_cal_timing(70200, v9) >> 10);
            if (v5 > 4)
                v3 = 4;
            else
                v3 = 9 - v5;
        ...
        case 7u:
            ...
            goto LABEL_73;
        case 8u:
            v29 = (unsigned __int8)libdram_auto_cal_timing(14, v9);
            if ((unsigned __int8)v29 < 5u)
                v29 = 5;
            v45 = v29;
            v6 = (unsigned __int8)libdram_auto_cal_timing(15, v9);
            if (v6 < 2)
                v6 = 2;
            v30 = (unsigned __int8)libdram_auto_cal_timing(2, v9);
            if ((unsigned __int8)v30 < 2u)
                v30 = 2;
            v41 = v30;
            v31 = (unsigned __int8)libdram_auto_cal_timing(5, v9);
            if ((unsigned __int8)v31 < 2u)
                v31 = 2;
            v39 = v31;
            v61 = (unsigned __int8)((unsigned int)(9 * v53) >> 5);
            v32 = libdram_auto_cal_timing(4, v9) + 17;
            v33 = libdram_auto_cal_timing(1, v9);
            v2->mr1 = 52;
            v2->mr2 = 27;
